...
const Footer = () => {
  return (
    <footer className="bg-[#de2c4d]/10 py-12 mt-12">
      <motion.div 
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        transition={{ duration: 1, delay: 0.2 }}
        className="text-center items-center sm:p-8 md:p-16 lg:p-20 flex justify-between items-center">
        {/* logo section */}
        <div className="text-2xl flex items-center gap-2 font-bold uppercase">
          <p className="text-[#de2c4d]">Fruit</p>
          <p className="text-[#fb923c]">Store</p>
